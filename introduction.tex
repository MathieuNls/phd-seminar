...
On a lighter note, Brian Russell resumed this into what he --- ironically --- named the Laws of Software Relativity \cite{RusselIRC}:
...
\subsubsection{Providers\label{sec:bug-provider}}
 ...
 In this study, we collect data from four different bug tracking systems: $Bugzilla$, $Jira$, $Github$ and $Sourceforge$. $Bugzilla$ belongs to the Mozilla foundation and have first been released in 1998. $Jira$ is provided by Altassian have been released 14 years ago, in 2002. $Bugzilla$ is 100\% open source and it's difficult to estimate how many project uses it.
