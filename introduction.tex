...
When a system crashes, software developers need to reproduce the crash (usually in a lab environment) in order to provide corrective measures.
...
\begin{itemize}
	...
	\item Chapter \ref{chap:aggreating} - {\it Aggregating Version Control and Project Management Systems}.
	In this chapter we discuss the components of JCHARMING, the bug reproduction approach we propose.
  \item Chapter \ref{chap:bumper} - {\it BUMPER: Bug Meta-repository For Developers & Researchers}.
	In this chapter, we discuss our framework and supporting tool for aggregating bug repositories into a uniform infrastructure.
